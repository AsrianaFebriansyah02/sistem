<?php foreach ($transaksi as $Transaksi) { ?>
    <div class="modal fade transaksi<?php echo $Transaksi->transaksi_id; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning" role="alert" align="center">
                        <b>Yakin </b>ingin menghapus data <span class="badge badge-pill badge-primary font-size-8"><?php echo $Transaksi->nominal; ?></span> ? <br>
